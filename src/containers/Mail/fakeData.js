...
export default JSON.parse(
  `[{
    "id": 30,
    "key": 30,
    "name": "Dynapreneur Analytics Platform",
    "cc": "-",
    "email": "-",
    "body": "Three (3) products about to expire within one (1) week. This will cost RM 340.20",
    "subject": "Product Expiration - RM 340.20",
    ...
    "cc": "-",
    "email": "-",
    "body": "Supplier (x) is not performing for consecutive 3 weeks and impact your ability to deliver RM 2300.00 of products to your customers in a timely manner",
    "subject": "Supplier Performance Impacting Revenue",
    "date": "2017-06-10T19:48:36.439Z",
    ...
    "cc": "-",
    "email": "-",
    "body": "Seasonal variation on product-line Strawberry Shortcakes will be in demand within 1 week based on last year's resulting sales",
    ...
    "tags": "Customers",
    "body": "You have three (3) items which are not profitable - they have been overstocked and only 10% of stock sold within the last month",
    "subject": "Product Overstocked and un-profitable",
    ...
    "tags": "Customers",
    "body": "Customer complained on service - three (3) similar complaints about the room service offered",
    "subject": "Issues with room service, customer complaints",
...
let x =  JSON.parse(
  ...
  "subject": "Est libero in. Id enim et vero velit enim nostrum cum aut libero.",
  "date": "2017-06-10T22:16:42.057Z",
  "bucket": "Inbox",
  "read": false
}, {
